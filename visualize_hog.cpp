...
int main(int argc, char** argv)
{
  ...
  //d.compute( img, descriptorsValues, Size(8,8), Size(32,32), locations);
...
//  cout << "6-1;";
  ...
  cout << "8;";
  //    return visual_image;
    namedWindow("people detector", 1);                               //新建一个窗�?
    imshow("people detector", visual_image);
